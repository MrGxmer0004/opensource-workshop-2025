# <img src="Images and vids\puzzle_piece.png" alt="Alt text" width="20 " height="20"> Installing Git

Before we begin installing Git, it will be better to create a GitHub account so that we don't have to toggle in between our installation and configuring process.

Link for signing up in GitHub --> [Sign Up](https://github.com/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F&source=header-home)

Now let us continue with our installation.

## <img src="Images and vids\link.png" alt="Alt text" width="20 " height="20"> 1. Open the Git website:
